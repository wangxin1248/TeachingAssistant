...
public class ExcelUtil {
    ...
    public static void initExcel(String fileName, String[] colName) {
        ...
        try {
            ...
            //createSheet(String,int)传入的int型参数代表sheet页号，0是第一页
            WritableSheet sheet = workbook.createSheet("成绩表", 0);
            /*
            Label中参数含义：列数、行数、要写的内容、输入这个lable里的样式然后通过sheet的add Cell()方法把内容写道sheet中（可选）
             */
    ...
    public static <T> int writeObjListToExcel(List<T> objList, String fileName, Context c) {
